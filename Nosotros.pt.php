...
<html lang="<?php echo $lang; ?>">
   ...
   <body class="main-layout home_page">
         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="first-slide" src="images/Equipo2.jpeg" alt="Primeiro slide" style="width: 1540px; height: auto;filter: brightness(0.5);">
                  <div class="container">
                     <div class="carousel-caption relative">

                        <section>
                           <h1 class="h1" style="font-size: 30px;">Nossa Empresa</h1>
                           <p>No Kinetic Cross Training, somos um ginásio dedicado a melhorar a saúde e o bem-estar da nossa comunidade em Ciudad Hidalgo e áreas ao redor. Especializamo-nos em fornecer um espaço acessível e motivador onde todos possam alcançar seu potencial físico máximo. Temos uma equipe dedicada e programas de treinamento personalizados projetados para atender às necessidades e objetivos de nossos clientes, promovendo assim uma vida mais saudável e equilibrada.</p>
                        ...
                        <section>
                           <h2 class="h2_e">Objetivo da Empresa</h2>
                           <p>Nos posicionar como o ginásio de cross training líder em Ciudad Hidalgo e em toda a região de Michoacán, alcançando maior retenção de clientes por meio de um serviço de alta qualidade, programas de treinamento adaptados a cada nível e um ambiente de comunidade que fomente a motivação e o compromisso de longo prazo com o fitness.</p>
                        </section>
                         
                        <section>
                           <h2 class="h2_e">Missão</h2>
                           <p>No Kinetic Cross Training, oferecemos um espaço acessível, profissional e motivador para que cada pessoa de Ciudad Hidalgo e da região alcance seu potencial físico máximo. Através de programas de treinamento personalizados e uma equipe dedicada, buscamos ajudar nossos clientes a alcançar uma vida mais saudável e equilibrada, promovendo o fitness como um pilar de bem-estar e desenvolvimento pessoal.</p>
                        </section>
                         
                        <section>
                           <h2 class="h2_e" style="left: -250px;">Visão</h2>
                           <p>Ser o ginásio de cross training de escolha em Michoacán, reconhecido pela nossa excelência no serviço, qualidade das nossas instalações e o impacto positivo que causamos na vida de cada cliente. Nosso objetivo é nos consolidar como a melhor opção para aqueles que buscam uma abordagem integrada de saúde e desempenho físico, contribuindo para uma comunidade mais saudável e ativa.</p>
      ...
      <footer>
         ...
         <div class="copyright">
            <div class="container">
               <p>2024 Meu Website. Todos os direitos reservados. <a href="https://html.design/">Kinetic Cross Training</a></p>
            </div>
         </div>
      </footer>
      <!-- fim do footer -->
