      ...
      <section class="slider_section">
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        ...
                        <p>No Kinetic Cross Training, promovemos exercícios em família em um ambiente acolhedor e acessível.<br>
                           Acreditamos que treinar juntos fortalece os laços familiares, por isso oferecemos programas<br>
                           adaptados para todas as idades e níveis, proporcionando uma experiência segura e personalizada para cada membro da família.</p>
                        <div class="button_section"> <a class="main_bt" href="#">Saiba Mais</a>  </div>
                        <ul class="locat_icon">
               ...
               <!-- Adicione os conteúdos dos segundo e terceiro slides de forma similar -->
            </div>
               ...
               <div class="row pdn-top-30">
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                     ...
                     <ul class="location_icon">
                        <li> <a href="https://www.facebook.com/KineticCeterFisioterapia"><img src="icon/facebook.png"></a></li>
                        <li> <a href="#"><img src="icon/Twitter.png"></a></li>
                        <li> <a href="#"><img src="icon/linkedin.png"></a></li>
                        <li> <a href="https://www.instagram.com/kineticcrosstraining"><img src="icon/instagram.png"></a></li>
                     </ul>
                  </div>
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                     ...
                     <p class="Newsletter">Cidade e Estado: Ciudad Hidalgo, Michoacán. <br>
