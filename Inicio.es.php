                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                      ...
                      <div class="contenedor">
                          <div class="bloque_es">
                              <h2 class="h2_e">Ejercicio en familia</h2>
                              <p>En Kinetic Cross Training, fomentamos el ejercicio en familia en un ambiente cálido y accesible.
                                   Creemos que entrenar juntos fortalece los lazos familiares, por lo que ofrecemos programas 
                                   adaptados a todas las edades y niveles, 
                                  donde cada miembro de la familia puede disfrutar de una experiencia segura y personalizada.</p>
                              <img src="images/Comunidad.jpeg" alt="Ejercicio en familia" class="bloque_img" style=" filter: brightness(0.8);">
                          </div>
                         
                          <div class="bloque_es">
                              <h2 class="h2_e">Inscripciones de lujo</h2>
                              <p>Nuestras inscripciones están pensadas para ofrecer la mejor relación calidad-precio
                                  , con tarifas accesibles y descuentos especiales para estudiantes. Queremos que todos
                                  , sin importar su situación, puedan integrarse a nuestra 
                                  comunidad y adoptar un estilo de vida saludable y activo.</p>
                              <img src="images/promo1.jpeg" alt="Inscripciones de lujo" class="bloque_img" style="filter: brightness(0.8)">
                          </div>
                        
                          <div class="bloque_es">
                              <h2 class="h2_e">Excelentes sesiones de alta calidad</h2>
                              <p>Cada sesión de entrenamiento en Kinetic Cross Training es de alta calidad, 
                                  diseñada para ser desafiante y competitiva. Ofrecemos planes personalizados 
                                  que se adaptan a las metas individuales, asegurando resultados efectivos y 
                                  un progreso constante para que cada persona alcance su máximo potencial.</p>
                              <img src="images/promo2.jpeg" alt="Excelentes sesiones de alta calidad" class="bloque_img" style="filter: brightness(0.8)">
                          </div>
                      </div>
