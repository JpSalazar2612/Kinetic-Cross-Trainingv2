   ...
   <body class="main-layout home_page">
      ...
      <section class="slider_section">
         <div class="carousel-item active">
            <img class="first-slide" src="images/Equipo2.jpeg" alt="First slide" style="width: 1540px; height: 1200px; filter: brightness(0.5);">
            <div class="container">
               <div class="carousel-caption relative">
                  <section>
                     ...
                     <div class="contenedor">
                        <div class="bloque_es">
                           <h2 class="h2_e">Family Exercise</h2>
                           <p>At Kinetic Cross Training, we promote family exercise in a warm and welcoming environment. 
                              We believe training together strengthens family bonds, so we offer programs tailored to all ages and levels, 
                              providing a safe and personalized experience for every family member.</p>
                           <img src="images/Comunidad.jpeg" alt="Family Exercise" class="bloque_img" style="filter: brightness(0.8);">
                        </div>
                        <div class="bloque_es">
                           <h2 class="h2_e">Premium Memberships</h2>
                           <p>Our memberships are designed to offer the best value, with affordable rates and special discounts for students. 
                              We aim to ensure that everyone, regardless of their situation, can join our community and adopt a healthy, active lifestyle.</p>
                           <img src="images/promo1.jpeg" alt="Premium Memberships" class="bloque_img" style="filter: brightness(0.8);">
                        </div>
                        <div class="bloque_es">
                           <h2 class="h2_e">High-Quality Training Sessions</h2>
                           <p>Each training session at Kinetic Cross Training is high quality, designed to be challenging and competitive. 
                              We provide personalized plans tailored to individual goals, ensuring effective results and continuous progress, 
                              helping everyone reach their full potential.</p>
                           <img src="images/promo2.jpeg" alt="High-Quality Training" class="bloque_img" style="filter: brightness(0.8);">
                        </div>
                     </div>
            ...
            <div class="container">
               <div class="row pdn-top-30">
                  ...
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                     ...
                     <p class="Newsletter">City and State: Ciudad Hidalgo, Michoacán. <br>
                     Address: Salazar 91 <br>
                     Phone: 4435770169 <br>
