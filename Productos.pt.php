         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                <img class="first-slide" src="images/Equipo2.jpeg" alt="Primeiro slide" style="width: 1540px; height: 1540px; filter: brightness(0.5);" >
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1 class="h1" style="font-size: 30px;">Promoções e/ou produtos</h1>
                                       <div class="aside-paneles">
                                          <aside class="aside">
                                              <h3 class="h2_e">Promoção Geral</h3>
                                        <ul>
                                          <li>Plano Geral </li>
                                          <li>Desconto de 10% em mensalidades anuais para estudantes!</li>
                                          <li>Pagamentos por transferência ou dinheiro</li>
                                        </ul>
                                              <img src="images/promo1.jpeg" alt="oferta alunos" class="img_promos" style="filter: brightness(0.8)">
                                          </aside>
                                          </aside>
                                          <aside class="aside">
                            
                                              <h3 class="h2_e">Promoção Personalizada</h3>
                                              <p>Conheça nossas novas camisetas esportivas.</p>
                                        <ul>
                                          <li>Plano personalizado</li>
                                          <li>Treinador individual</li>
                                          <li>Processos online</li>
                                        </ul>
                                              <img src="images/Equipo.jpeg" alt="oferta alunos" class="img_promos" style="filter: brightness(0.8)">
                                          </aside>
                                          <aside class="aside">
                            
                                              <h3 class="h2_e">Promoção Competitiva</h3>
                                              <ul>
                                          <li>Plano competitivo </li>
                                          <li>5 dias por semana</li>
                                          <li>Plano 100% personalizado</li>
                                        </ul>
                                              <img src="images/promo2.jpeg" alt="oferta alunos" class="img_promos" style="filter: brightness(0.8)">
                                          </aside>
                                          <aside class="aside">
                                              <h3 class="h2_e">Produto Destacado</h3>
                                              <p>Conheça nossos suplementos e roupas</p>
                                               <ul>
                                          <li>Creatina </li>
                                          <li>Pré-treino</li>
                                          <li>Suplemento</li>
                                        ...
                                        <img src="images/ropa.jpeg" alt="oferta alunos" class="img_promos" style="filter: brightness(0.8)">
                                          </aside>
                                          <aside class="aside">
                                              <h3 class="h2_e">Dica de Treinamento</h3>
                                              <p>Sabia que aquecer previne lesões?</p>
                                              <img src="images/consejo.jpeg" alt="oferta alunos" class="img_promos" style="filter: brightness(0.8)">
                                          </aside>
                                      </div>
