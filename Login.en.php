         ...
         <pre>
                  ...
                  <div class="registro-form">
                     ...
                     <form action="validate_user.php" method="POST">
                        ...
                        <input type="email" name="ema_email" id="ema_email" placeholder="Enter your email" required />

                        <!-- Password -->
                        <h3 class="h3">Password</h3>
                        <input type="password" name="pas_password" id="pas_password" placeholder="Enter your password" required />

                        <!-- Link to registration -->
                        <p style="text-align: center;">
                           Don't have an account? <a href="Register.en.php">Register here</a>
                        </p>
                     ...
                     <div class="container">
                        <div class="row pdn-top-30">
                           ...
                           <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12" style="left: 150px">
                              ...
                              <p class="Newsletter" >City and State: Ciudad Hidalgo, Michoacan. <br>
                              Address and Number: Salazar 91 <br>
                              Phone: 4435770169 <br>
