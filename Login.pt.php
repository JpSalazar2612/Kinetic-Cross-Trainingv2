         ...
         <pre>
                  ...
                  <div class="registro-form">
                     ...
                     <form action="validar_usuario.php" method="POST">
                        ...
                        <input type="email" name="ema_email" id="ema_email" placeholder="Digite seu e-mail" required />

                        <!-- Senha -->
                        <h3 class="h3">Senha</h3>
                        <input type="password" name="pas_password" id="pas_password" placeholder="Digite sua senha" required />

                        <!-- Link para registro -->
                        <p style="text-align: center;">
                           Não tem uma conta? <a href="Registro.pt.php">Cadastre-se aqui</a>
                        </p>
                     ...
                     <div class="container">
                        <div class="row pdn-top-30">
                           ...
                           <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12" style="left: 150px">
                              ...
                              Endereço e Número: Salazar 91 <br>
