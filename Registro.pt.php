...
<html lang="<?php echo $lang; ?>">
   ...
   <body class="main-layout home_page">
             ...
             <div class="row">
                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <div class="registro-form">
                         <h2 class="h2">¡Registre-se Agora!</h2>
                         <div id="error-message" style="color: red; display: none;">
                             Por favor, preencha todos os campos obrigatórios.
                         </div>
                         <div id="success-message" style="color: green; display: none;">
                             O formulário foi enviado com sucesso. Obrigado por se registrar!
                         </div>
                         <form id="formRegistro" action="registrar_usuario.php" method="POST" onsubmit="return validarFormulario()">
                             <!-- Correo -->
                             <h3 class="h3">E-mail</h3>
                             <input type="email" name="txt_Mail" id="txt_Mail" placeholder="Digite seu e-mail" required />
     
                             <!-- Teléfono -->
                             <h3 class="h3">Número de Telefone (10 dígitos)</h3>
                             <input type="text" name="txt_Telefone" id="txt_Telefone" placeholder="Número de telefone" required pattern="[0-9]{10}" />
     
                             <!-- Nombre -->
                             <h3 class="h3">Nome</h3>
                             <input type="text" name="txt_Nombre" id="txt_Nombre" placeholder="Nome" onkeyup="javascript:this.value=this.value.toUpperCase();" required />
     
                             <!-- Apellido Paterno -->
                             <h3 class="h3">Sobrenome</h3>
                             <input type="text" name="txt_ApPat" id="txt_ApPat" placeholder="Sobrenome" onkeyup="javascript:this.value=this.value.toUpperCase();" required />
     
                             <!-- Edad -->
                             <h3 class="h3">Idade</h3>
                             <input type="number" name="txt_Age" id="txt_Age" placeholder="Digite sua idade" required min="1" max="120" />
     
                             <!-- Género -->
                             <h3 class="h3">Gênero</h3>
                             <input type="radio" id="rad_Male" name="rad_Sex" value="Homem" required>
                             <label for="rad_Male">Homem</label>
                             <input type="radio" id="rad_Female" name="rad_Sex" value="Mulher">
                             <label for="rad_Female">Mulher</label>
     
                             <!-- Nivel -->
                             <h3 class="h3">Nível</h3>
                             <select name="txt_Nivel" id="txt_Nivel" required>
                                 <option value="">Selecione seu nível</option>
                                 <option value="Principiante">Principiante</option>
                                 <option value="Intermedio">Intermediário</option>
                                 <option value="Avanzado">Avançado</option>
                             </select>
     
                             <!-- Contraseña -->
                             <h3 class="h3">Senha (mínimo de 8 caracteres, inclua pelo menos uma letra e um número)</h3>
                             <input type="password" name="txt_password" id="txt_password" placeholder="Senha" required minlength="8" />
     
                             <!-- Confirmar Contraseña -->
                             <h3 class="h3">Confirmar Senha</h3>
                             <input type="password" name="txt_confirm_password" id="txt_confirm_password" placeholder="Confirmar Senha" required />
     
                             <!-- Botón para enviar -->
                             <button type="submit" id="btn_Guardar">Salvar</button>
                         </form>
                     </div>
                 </div>
             </div>
     ...
     <footer>
         ...
         <div class="container">
            <div class="row pdn-top-30">
               ...
               <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12" style="left: 150px">
                  ...
                  Tel: 4435770169 <br>
                  E-mail: Carlos.torresft@hotmail.com <br>
                  </p>
      ...
      <div class="copyright">
         <div class="container">
            <p>2024 Meu Site Web. Todos os direitos reservados. <a href="https://html.design/">Kinetic Cross training</a></p>
         </div>
      </div>
   </footer>
      <!-- end footer -->
