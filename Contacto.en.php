                 ...
                 <div class="row contact-icons text-center">
                     <div class="col-md-4 col-sm-4 col-xs-12">
                         <div class="contact-icon">
                             ...
                             <p>
                                 Phone: (+42) 443-577-0169<br>
                                 <span>Available Monday to Friday (9am-6pm)</span>
                             </p>
                         </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                         <div class="contact-icon">
                             ...
                             <p>
                                 Street & Number: Salazar 91<br>
                                 <span>Downtown, Hidalgo City, Michoacán</span>
                             </p>
                         </div>
                     </div>
                 </div>
                         ...
                         <div class="form contact-form">
                             ...
                             <form action="" method="post" role="form" class="contactForm">
                                 <div class="form-group">
                                     <input type="text" name="txt_Name" class="form-control" id="txt_Name" placeholder="Your Name" required />
                                     <div class="validation"></div>
                                 </div>
                                 <div class="form-group">
                                     <input type="email" name="txt_Email" class="form-control" id="txt_Email" placeholder="Your Email" required />
                                     <div class="validation"></div>
                                 </div>
                                 <div class="form-group">
                                     <input type="text" name="txt_Message" class="form-control" id="txt_Message" placeholder="Questions, suggestions, or comments" required />
                                     <div class="validation"></div>
                                 </div>
            ...
            <div class="container">
               <div class="row pdn-top-30">
                  ...
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12" style="left: 150px">
                     ...
                     <p class="Newsletter">City & State: Hidalgo City, Michoacán. <br>
                     Street & Number: Salazar 91 <br>
                     Phone: 4435770169 <br>
                     Email: Carlos.torresft@hotmail.com <br>
                     </p>
