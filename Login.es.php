         ...
         <pre>
                  ...
                  <div class="registro-form">
                     ...
                     <form action="validar_usuario.php" method="POST">
                        ...
                        <input type="password" name="pas_password" id="pas_password" placeholder="Ingresa tu contraseña" required />

                        <!-- Enlace para registro -->
                        <p style="text-align: center;">
                           ¿No tienes cuenta? <a href="Registro.es.php">Regístrate aquí</a>
                        </p>
